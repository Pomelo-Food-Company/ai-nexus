...
If the user hasn't provided a PR link or context — show them the prompt template from @.claude/shared/modules/dbt/prompts/dbt-reviewer-prompt.md and ask them to fill it in.
